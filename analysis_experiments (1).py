...
class Experiment:
    ...
    def exp_1a1(self, **kwargs):
        ...
        condition_trace_vals = ['-20.0','0.0','20.0']
        condition_ax = 'syn_dist'
        condition_ax_vals=[[0,300],[100,400],[200,500],[300,600],[0,200],[100,300],[200,400],[300,500],[400,600],]
        conditions_keep =['syn_num']
        conditions_keep_vals = [[12]]
        colors = ['blue', 'black', 'red']
        weight_plot, axes = analysis._plot_weights_mean(group_data=self.group_data, condition_ax=condition_ax, condition_ax_vals=condition_ax_vals, condition_trace=condition_trace, condition_trace_vals=condition_trace_vals, colors=colors, conditions_keep=conditions_keep, conditions_keep_vals=conditions_keep_vals)
        plt.show()
        ...
        weight_plot_final, axes = analysis._plot_weights_final(group_data=self.group_data, condition_ax=condition_ax, condition_ax_vals=condition_ax_vals, condition_trace=condition_trace, condition_trace_vals=condition_trace_vals, colors=colors, conditions_keep=conditions_keep, conditions_keep_vals=conditions_keep_vals)
        plt.show()
    ...
    def exp_3a2_dose(self, **kwargs):
        ...
        # plot average weight change across all synapses for a given polarity
        condition='polarity'
        condition_vals = ['-20.0','-5.0','-1.0','-0.5','0.0','0.5','1.0','5.0','20.0']
        colors = ['blue', 'blue','blue','blue','black', 'red', 'red', 'red', 'red']
        weight_plot = analysis._plot_weights_mean(group_data=self.group_data, condition=condition, condition_vals=condition_vals, colors=colors)
        plt.show()
    ...
    def exp_4a1(self, **kwargs):
        ...
        condition_trace_vals = ['-20.0','0.0','20.0']
        condition_ax = 'path'
        condition_ax_vals=['1','2']
        colors = ['blue', 'black', 'red']
        weight_plot, axes = analysis._plot_weights_mean(group_data=self.group_data, condition_ax=condition_ax, condition_ax_vals=condition_ax_vals, condition_trace=condition_trace, condition_trace_vals=condition_trace_vals, colors=colors)
        plt.show()
        ...
        # final weight change for each condition as bar graph
        weight_plot_final, axes = analysis._plot_weights_final(group_data=self.group_data, condition_ax=condition_ax, condition_ax_vals=condition_ax_vals, condition_trace=condition_trace, condition_trace_vals=condition_trace_vals, colors=colors)
        plt.show()
...
if __name__=='__main__':
    Experiment(experiment='exp_1a1', run_clopath=False)
